<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-10">
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid">
                                                    <a class="btn btn-danger btn-block" href="?c=regbeneficiario">Listado de Beneficiarios
                                                    <a class="btn btn-secondary btn-block" href="?pagina=afiliadoregistrar">Regresar a Registro de Afiliados</a></a>
                                                    <a class="btn btn-secondary btn-block" href="?pagina=afiliadoregistrar">Regresar a Registro de Afiliados</a>
            ...
            <div class="card shadow-lg border-0 rounded-lg mt-0">
                ...
                <div class="card-body">
                    <form action="?pagina=regbeneficiario" class="formulario" method= "post"  id="formulario"  onsubmit="return validar()">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-9">
                                              <input type="text" class="form-control" name="ci_beneficiarios"id="inputFirstName" required />
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-9">
                                              <input type="text" class="form-control" name="parentesco"id="inputFirstName" required />
                                              <label for="inputFirstName">Parentesco</label>
                                          </div>
                                    </div>
